...
const Hero = ({ theme }) => {
  return (
    <>
      <section className="w-[90vw] sm:w-[80vw] flex flex-col lg:flex-row lg:justify-between items-center gap-[88px] lg:h-screen 2xl:mt-[80px] ">
        {/* Quote */}

        <div className="flex flex-col items-center justify-center lg:items-start gap-[28px] w-full  max-lg:mt-[202px] ">
          <h1
